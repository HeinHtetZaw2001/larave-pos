...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="row mb-3">
                <div class="col">
                    <input type="text" placeholder="Customer Number"  class="form-control" id="CnName" value="{{ucwords('Hein Htet Zaw')}}">
                </div>
                <div class="col">
                ...
                <div class="row" id="products" style="height:600px!important;">
                        ...
                        <div class="col-6 col-md-4  ">
                            <div class="card product-card mb-3" data-id="{{$item->id}}">
                                <div class="card-body">
                                    <img class="product-img" src="{{asset('storage/item/'.$item->photo)}}" alt="">
                                    <hr>
        ...
        <div class="col-4 ">
            <div class="border rounded p-2" id="voucher">
                <h4 class="d-flex justify-content-between align-items-center mb-2">
                    <span class="" style="color:#950101">Current Order</span>
                    <div class="">
   ...
   let storeVoucher=[];
    ...
    function voucherListCreate(title,price,quantity,cost){
        ...
        <div class="w-75">
            ...
            <i class=" fas fa-trash-alt btn btn-outline-danger btn-sm cart-del-btn" style="margin-left: 35px!important;"></i>
        </div>
